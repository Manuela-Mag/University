...
class Drone:
    ...
    def moveDSF(self, detectedMap, screen, e):
         # TO DO!
         ...
         while len(stack) != 0:
             ...
             for i in range(0, walls[1]):
                 if not [row, col + i + 1] in visited and not [row, col + i + 1] in stack and detectedMap.surface[row][
                     col + i + 1] == 0:
...
def main():
    ...
    #cream drona
    d = Drone(x, y)
    #button = ButtonPy((0, 255, 0), 150, 225, 250, 100, 'Click Me')
    ...
    while running:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                #d.move(m)
                d.moveDSF(m, screen, e)
                print("You clicked the buttons")
